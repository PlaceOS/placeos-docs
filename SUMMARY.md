...
* [API](reference/api/README.md)
  * [Rest API](reference/api/rest-api/README.md)
    ...
    * [Assets](reference/api/rest-api/assets.md)
    ...
    * [MQTT/Analytics](reference/api/rest-api/mqtt-analytics.md)
    * [Repositories](reference/api/rest-api/repositories.md)
    * [Settings](reference/api/rest-api/settings.md)
