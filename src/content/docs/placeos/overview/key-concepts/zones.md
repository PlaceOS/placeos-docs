...
_Zones_ are collections of [systems](systems). A system can have tags marking it as a member of any number of zones.
...
2. A point to define [settings](settings) that need to affect a set of systems in the same way
