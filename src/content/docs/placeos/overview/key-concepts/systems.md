...
* A collection of [modules](/placeos/overview/key-concepts/modules)
* [Settings](/placeos/overview/key-concepts/settings) which will apply to the system and modules in it
...
[Zones](/placeos/overview/key-concepts/zones) are groups of systems which can reflect their physical or conceptual groupings. Systems can belong to zero or more zones.
