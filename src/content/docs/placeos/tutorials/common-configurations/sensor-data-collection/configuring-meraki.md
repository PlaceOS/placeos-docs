...
<!-- TODO: Add image showing webhook trigger configuration -->

Add the trigger to your location services system

<!-- TODO: Add image showing how to add webhook trigger -->

Once added, edit the webhook to enable tunnelling the data directly to the module

<!-- TODO: Add image showing action execution enablement -->

Click `Save` and copy the webhook link <!-- TODO: Add image showing webhook link copying -->
...
* <!-- TODO: Add image showing organizations ID --> Make note of the organisations ID
* <!-- TODO: Add image showing network ID list --> make note of the network ID from the list
...
<!-- TODO: Add image showing floorplans list for network --> Copy the result into a text editor
