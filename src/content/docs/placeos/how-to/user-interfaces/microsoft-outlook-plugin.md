...
To add the plugin, you will require administrator access to PlaceOS. You can follow the instructions below or reference the [Deploy a Frontend Interface](/placeos/how-to/user-interfaces/deploy-frontend) document.
...
<!-- TODO: Add screenshot - Outlook Plugin displayed in Web Browser after following configuration steps. -->
